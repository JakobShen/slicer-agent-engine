...
class SessionManager:
    ...
    def debug_state_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "active_transform_id": st.get("active_transform_id"),
            "active_transform_name": st.get("active_transform_name"),
            "last_registration_fixed_volume_id": st.get("last_registration_fixed_volume_id"),
            "last_registration_fixed_volume_name": st.get("last_registration_fixed_volume_name"),
            "last_registration_moving_volume_id": st.get("last_registration_moving_volume_id"),
            "last_registration_moving_volume_name": st.get("last_registration_moving_volume_name"),
            "last_registration_output_volume_id": st.get("last_registration_output_volume_id"),
            "last_registration_output_volume_name": st.get("last_registration_output_volume_name"),
    ...
    def summarize_tool_result(self, result: Any) -> Any:
        if isinstance(result, dict):
            ...
            important_keys = [
                ...
                "output_volume_name",
                "linear_transform_id",
                "linear_transform_name",
                "bspline_transform_id",
                "bspline_transform_name",
                "sampled_transform_id",
                "sampled_transform_name",
                "sampled_volume_id",
                "sampled_volume_name",
                "output_fixed_volume_roi_id",
                "output_fixed_volume_roi_name",
                "output_moving_volume_roi_id",
                "output_moving_volume_roi_name",
                "n_transforms",
                "n_transformed_nodes",
                "n_applied_nodes",
                "n_removed_nodes",
                "n_hardened_nodes",
                "n_component_transforms",
                "distance_mm",
                "angle_deg",
                "area_mm2",
                "area_cm2",
